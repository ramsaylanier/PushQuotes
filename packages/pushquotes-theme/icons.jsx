Icons = {
	DeleteIcon: <svg className="delete-icon deck-icon icon" x="0px" y="0px" viewBox="0 0 50 50" enable-background="new 0 0 50 50">
	...
	CopyIcon: 	<svg className="copy-icon deck-icon icon" x="0px" y="0px" viewBox="0 0 50 50" enable-background="new 0 0 50 50">
	...
	LogoIcon:<svg version="1.1" className="logo icon" x="0px" y="0px" viewBox="0 0 400 400" enable-background="new 0 0 400 400">
		...
		TwitterIcon:<svg className="icon twitter-icon" x="0px" y="0px" viewBox="0 0 40 40" enable-background="new 0 0 40 40">
